...
<body>
   ...
   <div class="container mt-5">
      ...
      ?>
            <h1 class="fw-bold mb-5">Edit id=<?php echo $selects['id'] ?></h1>
            <form action="config/edit.php" method="post" enctype="multipart/form-data">
               <div class="row mb-3">
                  <label for="name" class="col-sm-2 col-form-label">Name</label>
                  <div class="col-sm-10">
                     <input type="text" class="form-control" id="name" name="name" value="<?php echo $selects['name'] ?>">
                  </div>
               </div>
               <div class="row mb-3">
                  <label for="creator" class="col-sm-2 col-form-label">Creator</label>
                  <div class="col-sm-10">
                     <input type="text" class="form-control" id="creator" name="creator" value="<?php echo $selects['creator'] ?>">
                  </div>
               </div>
               <div class="row mb-3">
                  <label for="owner" class="col-sm-2 col-form-label">Owner</label>
                  <div class="col-sm-10">
                     <input type="text" class="form-control" id="owner" name="owner" value="<?php echo $selects['owner'] ?>">
                  </div>
               </div>
               <div class="row mb-3">
                  <label for="description" class="col-sm-2 col-form-label">Description</label>
                  <div class="col-sm-10">
                     <textarea type="text" class="form-control" id="description" name="description" rows="3"><?php echo $selects['description'] ?></textarea>
                  </div>
               </div>
               <div class="row mb-3">
                  <label for="price" class="col-sm-2 col-form-label">Price</label>
                  <div class="col-sm-10">
                     <input type="text" class="form-control" id="price" name="price" value="<?php echo $selects['price'] ?>">
                  </div>
               </div>
               <div class="row mb-3">
               ...
               <div class="text-center mt-5">
                  ...
                  <input type="submit" name="edit-nft" class="btn btn-primary py-2 px-5" value="Add">
               </div>
            </form>
      <?php
         }
