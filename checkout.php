   ...
   <div class="container detail-nft">
      <div class="row">
         ...
         <div class="col mt-3" style="margin-left: -90px;">
            <h1 class="title"><?php echo $selects['name'] ?></h1>
            <div>
            ...
            <div class="payment">
               <div class="d-flex justify-content-between">
                  <div class="price-text fw-reguler fs-5">NFT Price</div>
                  <div class="price-nft fw-bold fs-5"><?php echo $selects['price'] ?> ETH</div>
               </div>
               <div class="d-flex justify-content-between my-3">
                  <div class="price-text fw-reguler fs-5">Yung Fee</div>
                  <div class="price-nft fw-bold fs-5">1.5 ETH</div>
               </div>
               <div class="d-flex justify-content-between">
                  <div class="price-text fw-reguler fs-5">Gas Fee</div>
                  <div class="price-nft fw-bold fs-5">0.7 ETH</div>
               </div>
               <hr class="my-4">
               <div class="d-flex justify-content-between">
                  <div class="price-text fw-semibold fs-5">Total</div>
                  <div class="price-nft fw-bold fs-5">
                     <?php
                     $total = $selects['price'] + 1.5 + 0.7;
                     echo $total;
                     ?> ETH
                  </div>
               </div>
